...
::two-door-hero{primary-label="Run my business" primary-to="#apps" primary-sub="see the apps · start free" secondary-label="Build on the platform" secondary-to="/developers" secondary-sub="developers & ISVs"}
#title
...
::feature-grid{columns="3"}
  ::feature-card{title="CRM Suite" icon="crm" accent="cyan" summary="Track every lead from first hello to closed deal. See your whole pipeline on one board and never let a follow-up slip."}
  ::demo-button{app="crm-suite"}
  ::
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Inventory" icon="inventory" accent="amber" summary="Know what's in stock, what's running low, and what to reorder — before you run out. Receipts, counts, and low-stock alerts built in."}
  ::demo-button{app="inventory-yoke"}
  ::
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Project Tracker" icon="project-tracker" accent="violet" summary="Run projects on a simple board. Tasks move from to-do to done, and everyone can see exactly where things stand."}
  ::demo-button{app="simple-project-tracker"}
  ::
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Accounting" icon="accounting" accent="emerald" summary="Send invoices, track the bills you owe, and keep your books balanced. Chart of accounts, AR/AP, and a clean ledger out of the box."}
  ::demo-button{app="yoke-ledger"}
  ::
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Field Service" icon="field-service" accent="sky" summary="Schedule jobs, dispatch your crew, and invoice the moment work is finished. Every job moves New → Dispatched → On-site → Invoiced."}
  ::demo-button{app="yoke-hvac"}
  ::
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Forms — free" icon="forms" accent="rose" summary="Build a form, share a link, collect responses — and email a PDF copy automatically. Free forever, no credit card."}
...
::feature-grid{columns="3"}
  ::feature-card{title="Warehouse Management" icon="warehouse" accent="amber" summary="Receive, putaway, pick, pack, ship, and cycle count — all with a guided scan console. Soft-reservation availability so two pickers never grab the same unit."}
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
  ::feature-card{title="Logistics core (free)" icon="logistics" accent="cyan" summary="The shared substrate every logistics app builds on — facilities, bins, zones, movements, and the immutable event log. Free with every tenant; add WMS, TMS, or 3PL when you need them."}
  ::cta-button{to="/docs/marketplace" variant="secondary" size="sm"}
  Learn more
  ::
  ::
...
#title
Watch a job move through your workflow

#lede
Every job follows a clear path — New → Dispatched → On-site → Invoiced — so nothing gets lost and everyone knows what's next. No jargon, no setup required to look.
...
#default
Rename fields, add a form, or tweak the workflow with the visual builder. Start on a ready-made app today and shape it to how you actually work. **Outgrow it? You're not locked in — your data and your app are always yours to take with you.**

::cta-button{to="/developers" variant="secondary" size="md"}
See how builders extend FastYoke
::
::
...
#lede
Forms are free forever. Paid tiers scale from a single team to a regulated fleet — and you can compare FastYoke to what you're paying now.
...
#title
Own it. Extend it. Export it.

#default
Open architecture, a typed SDK, a visual app studio, and a clean exit: take your frontend, your compiled rules, and your databases with you whenever you want.

::cta-button{to="/developers" variant="primary" size="lg"}
